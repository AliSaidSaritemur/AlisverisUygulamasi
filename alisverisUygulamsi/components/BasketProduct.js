            ...
            <View style={styles.buttonConatiner}>
                ...
                <View style={styles.icons}>
                    <TouchableOpacity onPress={() => {
                        basketProduct.Count > 1 ? decreaseProductCount(basketProduct.BasketProductId) : removeBasketProduct(basketProduct.BasketProductId);
                        refresh();
                    }}>
                    ...
                    <TouchableOpacity onPress={() => {
                        increaseProductCount(basketProduct.BasketProductId);
                        refresh();
                    }}>
                ...
                <TouchableOpacity style={styles.removeAllButton} onPress={() => {
                    removeBasketProduct(basketProduct.BasketProductId);
                    refresh();
                }}>
